...
export const styles = StyleSheet.create({
  ...
  authScreen: { flex: 1 },
  onboardingScreen: { flex: 1, paddingHorizontal: 20, paddingTop: 10, paddingBottom: 18, justifyContent: 'space-between', backgroundColor: '#0B0E14' },
  onboardingTopRow: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  onboardingBrand: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  onboardingBrandText: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 14, letterSpacing: 0.2 },
  onboardingSkip: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 18, backgroundColor: '#FFFFFF0A', borderWidth: 1, borderColor: '#FFFFFF14' },
  onboardingSkipText: { color: '#FFFFFFB3', fontFamily: 'Inter_500Medium', fontSize: 12 },
  onboardingFeatureCard: { flex: 1, marginTop: 10, marginBottom: 16, padding: 18, justifyContent: 'space-between', borderRadius: 30, backgroundColor: '#FFFFFF0A', borderWidth: 1, borderColor: '#FFFFFF26', overflow: 'hidden', shadowColor: '#00D2D3', shadowOpacity: 0.2, shadowRadius: 32, shadowOffset: { width: 0, height: 10 } },
  onboardingVisualStage: { height: 278, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  onboardingCopy: { alignItems: 'center', gap: 10, paddingHorizontal: 4, paddingBottom: 4 },
  onboardingEyebrow: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 9, letterSpacing: 1.7, textAlign: 'center' },
  onboardingLotus: { width: 176, height: 176, borderRadius: 88, alignItems: 'center', justifyContent: 'center', backgroundColor: '#8E44AD24', shadowColor: '#00D2D3', shadowOpacity: 0.65, shadowRadius: 40, shadowOffset: { width: 0, height: 0 } },
  onboardingTitle: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 30, lineHeight: 36, textAlign: 'center', letterSpacing: -0.5 },
  onboardingBody: { maxWidth: 320, color: '#FFFFFFB3', fontFamily: 'Inter_400Regular', fontSize: 14, lineHeight: 21, textAlign: 'center' },
  onboardingMoveCard: { position: 'absolute', left: 10, right: 10, bottom: 10, minHeight: 66, paddingHorizontal: 14, paddingVertical: 11, borderRadius: 19, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#101820E6', borderWidth: 1, borderColor: '#48EFEF59', shadowColor: '#00D2D3', shadowOpacity: 0.3, shadowRadius: 18 },
  onboardingMoveIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#00D2D326' },
  onboardingMoveKicker: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 8, letterSpacing: 1.2 },
  onboardingMoveText: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 13, lineHeight: 18, marginTop: 2 },
  onboardingOrbit: { width: 210, height: 210, borderRadius: 105, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#00D2D340', backgroundColor: '#00D2D30D', shadowColor: '#8E44AD', shadowOpacity: 0.45, shadowRadius: 34 },
  onboardingOrbitCenter: { width: 82, height: 82, borderRadius: 41, alignItems: 'center', justifyContent: 'center', backgroundColor: '#101820E8', borderWidth: 1, borderColor: '#48EFEF66', shadowColor: '#00D2D3', shadowOpacity: 0.55, shadowRadius: 24 },
  onboardingLeakChip: { position: 'absolute', minHeight: 40, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 15, flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: '#141720F2', borderWidth: 1, borderColor: '#FFFFFF26' },
  onboardingLeakChipLeft: { left: -34, top: 38 },
  onboardingLeakChipRight: { right: -42, top: 82 },
  onboardingLeakChipBottom: { bottom: 2, left: 28 },
  onboardingLeakName: { color: '#FFFFFFCC', fontFamily: 'Inter_500Medium', fontSize: 10 },
  onboardingLeakPrice: { color: '#FFB3C7', fontFamily: 'Inter_700Bold', fontSize: 10 },
  onboardingScoreRing: { width: 172, height: 172, borderRadius: 86, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111722E8', borderWidth: 4, borderColor: '#00D2D3', shadowColor: '#00D2D3', shadowOpacity: 0.6, shadowRadius: 32 },
  onboardingScoreValue: { color: '#FFFFFF', fontFamily: 'Inter_300Light', fontSize: 42, lineHeight: 46, marginTop: -3 },
  onboardingScoreLabel: { color: '#FFFFFF80', fontFamily: 'Inter_700Bold', fontSize: 8, letterSpacing: 1.5 },
  onboardingWinCard: { position: 'absolute', minHeight: 42, paddingHorizontal: 11, paddingVertical: 9, borderRadius: 15, flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: '#141720F2', borderWidth: 1, borderColor: '#FFFFFF26', shadowColor: '#000', shadowOpacity: 0.35, shadowRadius: 14 },
  onboardingWinCardLeft: { left: 2, bottom: 26 },
  onboardingWinCardRight: { right: 0, top: 28 },
  onboardingWinText: { color: '#FFFFFFD9', fontFamily: 'Inter_500Medium', fontSize: 10 },
  onboardingCoachHalo: { width: 94, height: 94, borderRadius: 47, alignItems: 'center', justifyContent: 'center', backgroundColor: '#00D2D31A', borderWidth: 1, borderColor: '#00D2D34D', shadowColor: '#00D2D3', shadowOpacity: 0.5, shadowRadius: 28, marginTop: -96 },
  onboardingChatCard: { position: 'absolute', paddingHorizontal: 13, paddingVertical: 11, borderRadius: 17, borderWidth: 1, shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 14 },
  onboardingUserChat: { top: 82, right: 0, maxWidth: '76%', backgroundColor: '#8E44AD30', borderColor: '#C78BDF59' },
  onboardingCoachChat: { left: 0, right: 18, bottom: 10, backgroundColor: '#101820F2', borderColor: '#48EFEF59' },
  onboardingCoachKicker: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 8, letterSpacing: 1.2, marginBottom: 5 },
  onboardingChatText: { color: '#FFFFFF', fontFamily: 'Inter_500Medium', fontSize: 12, lineHeight: 17 },
  onboardingForecastRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
  onboardingForecastText: { color: '#FFFFFF80', fontFamily: 'Inter_400Regular', fontSize: 9 },
  onboardingFooter: { gap: 12 },
  onboardingPagination: { height: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  onboardingDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#FFFFFF30' },
  onboardingDotActive: { width: 24, backgroundColor: '#48EFEF', shadowColor: '#00D2D3', shadowOpacity: 0.8, shadowRadius: 8 },
  onboardingButtonRow: { flexDirection: 'row', gap: 10 },
  onboardingBackButton: { width: 54, minHeight: 48, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF0D', borderWidth: 1, borderColor: '#FFFFFF26' },
  onboardingNextButton: { flex: 1 },
  onboardingPromise: { color: '#FFFFFF66', fontFamily: 'Inter_400Regular', fontSize: 9, lineHeight: 13, textAlign: 'center' },
  ...
  zenFrame: { flex: 1, marginHorizontal: 10, marginTop: 7, marginBottom: 7, borderRadius: 30, borderWidth: 1, borderColor: '#FFFFFF2E', overflow: 'hidden', shadowColor: '#00D2D3', shadowOpacity: 0.16, shadowRadius: 28, shadowOffset: { width: 0, height: 0 } },
  zenHomeScroll: { paddingHorizontal: 18, paddingTop: 16, paddingBottom: 28, gap: 18 },
  ...
  zenScorePill: { alignSelf: 'center', minHeight: 54, minWidth: 228, paddingVertical: 9, paddingHorizontal: 14, borderRadius: 20, flexDirection: 'row', alignItems: 'center', gap: 10, borderColor: '#48EFEF4D', shadowColor: '#00D2D3', shadowOpacity: 0.28, shadowRadius: 20 },
  zenScorePillGlow: { position: 'absolute', width: 130, height: 70, borderRadius: 65, left: 38, top: -34, backgroundColor: '#00D2D31F' },
  ...
  zenScoreOverline: { color: '#FFFFFF70', fontFamily: 'Inter_700Bold', fontSize: 7, letterSpacing: 1.2, marginBottom: 2 },
  zenScoreText: { color: '#FFFFFF', fontSize: 14, fontFamily: 'Inter_700Bold' },
  zenScoreDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: '#79E6B0' },
  zenGlass: { backgroundColor: '#FFFFFF0D', borderWidth: 1, borderRadius: 24, padding: 16, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.4, shadowRadius: 34, shadowOffset: { width: 0, height: 10 }, elevation: 8 },
  zenGlassBlur: StyleSheet.absoluteFill,
  zenGlassTint: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, backgroundColor: '#FFFFFF0D', borderRadius: 24, borderTopWidth: 1, borderLeftWidth: 1, borderTopColor: '#FFFFFF1F', borderLeftColor: '#FFFFFF12' },
  primaryButtonPulse: { width: '100%' },
  primaryButtonPulseCompact: { width: 'auto', flex: 1 },
  zenInsightCard: { gap: 13, borderColor: '#48EFEF66', shadowColor: '#00D2D3', shadowOpacity: 0.42, shadowRadius: 28, padding: 18 },
  zenInsightGlowTeal: { position: 'absolute', width: 220, height: 180, borderRadius: 110, top: -98, left: -72, backgroundColor: '#00D2D329' },
  zenInsightGlowViolet: { position: 'absolute', width: 180, height: 180, borderRadius: 90, right: -90, bottom: -96, backgroundColor: '#8E44AD2B' },
  zenInsightLotusWatermark: { position: 'absolute', right: -26, top: 20, opacity: 0.13 },
  ...
  zenStatCard: { flex: 1, minHeight: 112, padding: 12, borderRadius: 20, backgroundColor: '#FFFFFF0E', borderWidth: 1, borderColor: '#FFFFFF26', gap: 7, overflow: 'hidden', shadowColor: '#00D2D3', shadowOpacity: 0.14, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } },
  zenStatHeader: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  zenStatIcon: { width: 26, height: 26, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: '#00D2D326' },
  zenStatIconViolet: { backgroundColor: '#8E44AD2E' },
  ...
  zenStatSignal: { height: 3, borderRadius: 2, backgroundColor: '#FFFFFF12', overflow: 'hidden', marginTop: 'auto' },
  zenStatSignalFill: { height: 3, borderRadius: 2, backgroundColor: '#48EFEF', shadowColor: '#00D2D3', shadowOpacity: 0.8, shadowRadius: 5 },
  zenStatSignalViolet: { backgroundColor: '#8E44AD18' },
  zenStatSignalFillViolet: { backgroundColor: '#C78BDF', shadowColor: '#8E44AD' },
  zenLinkGrid: { flexDirection: 'row', gap: 10 },
  zenLinkCard: { flex: 1, minHeight: 116, padding: 14, borderRadius: 22, backgroundColor: '#00D2D312', borderWidth: 1, borderColor: '#00D2D34D', gap: 5, overflow: 'hidden', shadowColor: '#00D2D3', shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 8 } },
  zenLinkCardViolet: { backgroundColor: '#8E44AD14', borderColor: '#8E44AD59', shadowColor: '#8E44AD' },
  zenLinkGlowTeal: { position: 'absolute', width: 100, height: 100, borderRadius: 50, right: -42, top: -48, backgroundColor: '#00D2D326' },
  zenLinkGlowViolet: { position: 'absolute', width: 100, height: 100, borderRadius: 50, right: -42, top: -48, backgroundColor: '#8E44AD33' },
  zenLinkIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#00D2D324', borderWidth: 1, borderColor: '#00D2D340' },
  zenLinkIconViolet: { backgroundColor: '#8E44AD2E', borderColor: '#C78BDF40' },
  zenLinkTitle: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 13 },
  zenLinkMeta: { color: '#FFFFFF80', fontFamily: 'Inter_400Regular', fontSize: 10 },
  zenLinkArrow: { position: 'absolute', right: 12, bottom: 12 },
  ...
  paywallScroll: { paddingHorizontal: 18, paddingTop: 12, paddingBottom: 24, gap: 13 },
  paywallTopRow: { minHeight: 38, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  paywallClose: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF0A', borderWidth: 1, borderColor: '#FFFFFF1A' },
  paywallCloseSpacer: { width: 38, height: 38 },
  paywallBrand: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  paywallBrandText: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 13 },
  paywallHeroCopy: { alignItems: 'center', gap: 9, paddingHorizontal: 4 },
  paywallTrialBadge: { minHeight: 28, paddingHorizontal: 11, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#00D2D31A', borderWidth: 1, borderColor: '#48EFEF4D' },
  paywallTrialBadgeText: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 9, letterSpacing: 1.3 },
  paywallHeadline: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 28, lineHeight: 34, letterSpacing: -0.6, textAlign: 'center' },
  paywallSubhead: { maxWidth: 330, color: '#FFFFFFA3', fontFamily: 'Inter_400Regular', fontSize: 13, lineHeight: 19, textAlign: 'center' },
  paywallBenefitsCard: { padding: 13, borderColor: '#FFFFFF29', shadowColor: '#8E44AD', shadowOpacity: 0.2, shadowRadius: 22 },
  paywallBenefitsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  paywallBenefit: { width: '48%', minHeight: 54, padding: 8, borderRadius: 15, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFFFFF08', borderWidth: 1, borderColor: '#FFFFFF14' },
  paywallBenefitIcon: { width: 29, height: 29, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  paywallBenefitTitle: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 10, lineHeight: 14 },
  paywallBenefitDetail: { color: '#FFFFFF73', fontFamily: 'Inter_400Regular', fontSize: 8.5, lineHeight: 12, marginTop: 1 },
  paywallProof: { color: '#79E6B0', fontFamily: 'Inter_500Medium', fontSize: 10, lineHeight: 15, textAlign: 'center', marginTop: 9 },
  paywallFreeLink: { minHeight: 32, alignItems: 'center', justifyContent: 'center' },
  paywallFreeLinkText: { color: '#FFFFFFB3', fontFamily: 'Inter_600SemiBold', fontSize: 12, textDecorationLine: 'underline' },
  paywallFooterLinks: { minHeight: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 },
  paywallFooterLink: { color: '#FFFFFF80', fontFamily: 'Inter_500Medium', fontSize: 9 },
  paywallFooterDot: { width: 3, height: 3, borderRadius: 2, backgroundColor: '#FFFFFF4D' },
  paywallDisclosure: { textAlign: 'center', fontSize: 9, lineHeight: 14, paddingHorizontal: 4 },
  auditCard: { gap: 10 },
  ...
  smartBudgetScroll: { paddingHorizontal: 18, paddingTop: 18, paddingBottom: 30, gap: 14 },
  smartBudgetHeader: { minHeight: 54, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  smartBudgetTitle: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 27, letterSpacing: -0.5 },
  smartBudgetMonth: { color: '#FFFFFF99', fontFamily: 'Inter_500Medium', fontSize: 12, marginTop: 4 },
  smartBudgetSyncBadge: { minHeight: 34, paddingHorizontal: 11, borderRadius: 17, borderWidth: 1, borderColor: '#FFFFFF26', backgroundColor: '#FFFFFF0D', flexDirection: 'row', alignItems: 'center', gap: 6 },
  smartBudgetSyncText: { color: '#FFFFFFB3', fontFamily: 'Inter_500Medium', fontSize: 10 },
  smartBudgetTargetCard: { gap: 12, borderColor: '#00D2D34D', backgroundColor: '#071019CC' },
  smartBudgetEyebrow: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 9, letterSpacing: 1.4 },
  smartBudgetPrompt: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 18 },
  smartBudgetCurrencyInput: { minHeight: 72, borderRadius: 26, borderWidth: 1.5, borderColor: '#FFFFFF26', backgroundColor: '#FFFFFF0D', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20 },
  smartBudgetCurrencySign: { color: '#FFFFFF99', fontFamily: 'Inter_600SemiBold', fontSize: 28 },
  smartBudgetCurrencyValue: { minWidth: 90, color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 32, textAlign: 'center', paddingVertical: 8 },
  smartBudgetSupport: { color: '#FFFFFF99', fontFamily: 'Inter_400Regular', fontSize: 11, lineHeight: 16 },
  smartBudgetPlanCard: { gap: 13, borderWidth: 1.5, backgroundColor: '#071019CC' },
  smartBudgetLedger: { borderRadius: 16, borderWidth: 1, borderColor: '#FFFFFF1A', paddingHorizontal: 12, paddingVertical: 4, backgroundColor: '#FFFFFF08' },
  smartBudgetLedgerRow: { minHeight: 42, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  smartBudgetLedgerValue: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 13, fontVariant: ['tabular-nums'] },
  smartBudgetLedgerSubtract: { color: '#FFFFFF99', fontFamily: 'Inter_600SemiBold', fontSize: 13, fontVariant: ['tabular-nums'] },
  smartBudgetLedgerDivider: { height: 1, backgroundColor: '#FFFFFF26' },
  smartBudgetLedgerStrong: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 12 },
  smartBudgetLedgerStrongValue: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 16, fontVariant: ['tabular-nums'] },
  smartBudgetBuffer: { minHeight: 58, paddingHorizontal: 12, borderRadius: 16, borderWidth: 1, borderColor: '#00D2D34D', backgroundColor: '#00D2D312', flexDirection: 'row', alignItems: 'center', gap: 9 },
  smartBudgetBufferShortfall: { borderColor: '#FF8FB366', backgroundColor: '#FF8FB312' },
  smartBudgetBufferLabel: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 11 },
  smartBudgetBufferMeta: { color: '#FFFFFF73', fontFamily: 'Inter_400Regular', fontSize: 8, marginTop: 2 },
  smartBudgetBufferValue: { color: '#48EFEF', fontFamily: 'Inter_700Bold', fontSize: 14, fontVariant: ['tabular-nums'] },
  smartBudgetNeedsRebuild: { color: '#F5D58A', fontFamily: 'Inter_500Medium', fontSize: 10, lineHeight: 15, textAlign: 'center' },
  smartBudgetControlsCard: { gap: 12, borderColor: '#FFFFFF26', backgroundColor: '#FFFFFF08' },
  smartBudgetSectionHeader: { minHeight: 46, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  smartBudgetSectionTitle: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 15 },
  smartBudgetSectionMeta: { color: '#FFFFFF73', fontFamily: 'Inter_400Regular', fontSize: 9, lineHeight: 14, marginTop: 3 },
  smartBudgetIconButton: { width: 44, height: 44, borderRadius: 14, borderWidth: 1, borderColor: '#00D2D34D', backgroundColor: '#00D2D314', alignItems: 'center', justifyContent: 'center' },
  smartBudgetChoiceRow: { minHeight: 44, padding: 3, borderRadius: 14, backgroundColor: '#FFFFFF0D', flexDirection: 'row', gap: 4 },
  smartBudgetChoice: { flex: 1, minHeight: 38, borderRadius: 11, alignItems: 'center', justifyContent: 'center' },
  smartBudgetChoiceActive: { backgroundColor: '#00D2D326', borderWidth: 1, borderColor: '#00D2D34D' },
  smartBudgetChoiceText: { color: '#FFFFFF73', fontFamily: 'Inter_500Medium', fontSize: 10 },
  smartBudgetChoiceTextActive: { color: '#48EFEF', fontFamily: 'Inter_600SemiBold' },
  smartBudgetDetectedValue: { color: '#FFFFFFB3', fontFamily: 'Inter_500Medium', fontSize: 11, paddingHorizontal: 4 },
  smartBudgetInlineInput: { minHeight: 48, borderRadius: 14, borderWidth: 1, borderColor: '#00D2D34D', backgroundColor: '#FFFFFF0D', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12 },
  smartBudgetInlineSign: { color: '#FFFFFF80', fontFamily: 'Inter_600SemiBold', fontSize: 12 },
  smartBudgetInlineValue: { flex: 1, color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 14, paddingHorizontal: 5, paddingVertical: 8 },
  smartBudgetSettingsPanel: { minHeight: 58, padding: 10, borderRadius: 14, borderWidth: 1, borderColor: '#8E44AD4D', backgroundColor: '#8E44AD12', flexDirection: 'row', alignItems: 'center', gap: 10 },
  smartBudgetSmallInput: { minWidth: 84, minHeight: 44, borderRadius: 12, borderWidth: 1, borderColor: '#FFFFFF26', backgroundColor: '#FFFFFF0D', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8 },
  smartBudgetSmallInputValue: { minWidth: 52, color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 12, textAlign: 'right', paddingHorizontal: 3, paddingVertical: 7 },
  smartBudgetBillEditorList: { gap: 8 },
  smartBudgetBillEditorRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 9, paddingVertical: 4, borderTopWidth: 1, borderTopColor: '#FFFFFF14' },
  smartBudgetUserBillIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: '#8E44AD1F', alignItems: 'center', justifyContent: 'center' },
  smartBudgetRemoveButton: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  smartBudgetAddLink: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 4 },
  smartBudgetAddLinkText: { color: '#48EFEF', fontFamily: 'Inter_600SemiBold', fontSize: 11 },
  smartBudgetAddBillPanel: { gap: 8, paddingTop: 4 },
  smartBudgetTextInput: { minHeight: 46, borderRadius: 14, borderWidth: 1, borderColor: '#FFFFFF26', backgroundColor: '#FFFFFF0D', color: '#FFFFFF', paddingHorizontal: 12, fontFamily: 'Inter_500Medium', fontSize: 12 },
  smartBudgetAddBillActions: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  smartBudgetAddButton: { width: 48, height: 48, borderRadius: 15, backgroundColor: '#48EFEF', alignItems: 'center', justifyContent: 'center' },
  smartBudgetCategoryList: { gap: 4 },
  smartBudgetCategoryRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 10, borderTopWidth: 1, borderTopColor: '#FFFFFF14' },
  smartBudgetCategoryIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: '#FFFFFF0D', alignItems: 'center', justifyContent: 'center' },
  smartBudgetWhyCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, borderColor: '#8E44AD4D', backgroundColor: '#8E44AD12' },
  smartBudgetWhyLine: { color: '#FFFFFFB3', fontFamily: 'Inter_400Regular', fontSize: 10, lineHeight: 16, marginTop: 5 },
  smartBudgetAuditLink: { color: '#B982D2', fontFamily: 'Inter_500Medium', fontSize: 9, lineHeight: 14, marginTop: 7 },
  smartBudgetOverrideRow: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, paddingHorizontal: 4 },
  smartBudgetOverrideText: { color: '#FFFFFF80', fontFamily: 'Inter_500Medium', fontSize: 10 },
  smartBudgetResetText: { color: '#48EFEF', fontFamily: 'Inter_600SemiBold', fontSize: 10 },
  ...
  metric: { flex: 1, minHeight: 92, borderWidth: 1, borderRadius: 20, padding: 12, gap: 4, backgroundColor: '#FFFFFF0D', shadowColor: '#00D2D3', shadowOpacity: 0.12, shadowRadius: 14, shadowOffset: { width: 0, height: 7 } },
  ...
  actionRowInteractive: { backgroundColor: '#FFFFFF0D' },
  glassRow: { minHeight: 72, paddingHorizontal: 14, paddingVertical: 12, borderRadius: 20, borderWidth: 1, borderColor: '#FFFFFF1F', backgroundColor: '#FFFFFF08', flexDirection: 'row', alignItems: 'center', gap: 12, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } },
  ...
  sectionTitle: { fontSize: 18, fontFamily: 'Inter_600SemiBold', letterSpacing: 0.2, marginTop: 10, textShadowColor: '#00D2D329', textShadowRadius: 12 },
  ...
  chatList: { flexGrow: 1, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 18, gap: 18 },
  chatTurn: { gap: 12 },
  ...
  coachScreenHeader: { paddingHorizontal: 16, paddingTop: 14, paddingBottom: 6, gap: 10 },
  coachHeaderTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  coachBrandRow: { flex: 1, minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: 10 },
  coachBrandIcon: { width: 40, height: 40, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  coachHeaderTitle: { fontFamily: 'Inter_700Bold', fontSize: 21, lineHeight: 25 },
  coachHeaderSubtitle: { fontFamily: 'Inter_400Regular', fontSize: 11, lineHeight: 15, marginTop: 1 },
  coachScorePill: { minWidth: 58, height: 34, borderRadius: 17, borderWidth: 1, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  coachScoreText: { fontFamily: 'Inter_700Bold', fontSize: 13, fontVariant: ['tabular-nums'] },
  coachGroundingRow: { minHeight: 34, borderWidth: 1, borderRadius: 12, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 7 },
  coachGroundingText: { flex: 1, minWidth: 0, fontFamily: 'Inter_500Medium', fontSize: 10, lineHeight: 14 },
  coachContextRail: { flexDirection: 'row', gap: 8, paddingRight: 16 },
  coachContextChip: { minHeight: 34, maxWidth: 230, borderWidth: 1, borderRadius: 17, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 6 },
  coachContextLabel: { maxWidth: 92, fontFamily: 'Inter_500Medium', fontSize: 10 },
  coachContextValue: { maxWidth: 94, fontFamily: 'Inter_700Bold', fontSize: 10, textTransform: 'capitalize' },
  userMessageWrap: { alignItems: 'flex-end' },
  userBubble: { maxWidth: '84%', backgroundColor: '#8E44AD2E', borderWidth: 1, borderColor: '#C268E84D', borderRadius: 20, borderBottomRightRadius: 7, paddingVertical: 11, paddingHorizontal: 15 },
  userBubbleText: { color: '#F4E7FA', fontFamily: 'Inter_500Medium', fontSize: 14, lineHeight: 20 },
  coachAnswerCard: { borderWidth: 1, borderRadius: 22, padding: 16, gap: 14, shadowColor: '#00D2D3', shadowOpacity: 0.12, shadowRadius: 20, shadowOffset: { width: 0, height: 8 }, elevation: 4 },
  coachAnswerHeader: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  coachAnswerKicker: { fontFamily: 'Inter_700Bold', fontSize: 10, letterSpacing: 1.1 },
  coachAnswerMeta: { fontFamily: 'Inter_400Regular', fontSize: 10, lineHeight: 14, marginTop: 1 },
  coachAnswerText: { fontFamily: 'Inter_600SemiBold', fontSize: 18, lineHeight: 26, letterSpacing: -0.1 },
  coachEvidenceWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  coachEvidencePill: { maxWidth: '100%', minHeight: 32, borderWidth: 1, borderRadius: 16, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 6 },
  coachEvidenceDot: { width: 6, height: 6, borderRadius: 3 },
  coachEvidenceLabel: { flexShrink: 1, fontFamily: 'Inter_500Medium', fontSize: 10, lineHeight: 14 },
  coachEvidenceValue: { fontFamily: 'Inter_700Bold', fontSize: 11, lineHeight: 14, fontVariant: ['tabular-nums'] },
  factLine: { fontSize: 12, lineHeight: 17 },
  coachRecommendation: { borderWidth: 1, borderRadius: 17, padding: 13, gap: 9 },
  coachRecommendationKicker: { fontFamily: 'Inter_700Bold', fontSize: 9, letterSpacing: 1.1 },
  coachRecommendationRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  coachRecommendationText: { flex: 1, minWidth: 0, fontFamily: 'Inter_500Medium', fontSize: 13, lineHeight: 19 },
  coachAnswerActions: { gap: 8 },
  coachPlanButton: { minHeight: 46, borderRadius: 23, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, shadowColor: '#00D2D3', shadowOpacity: 0.25, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
  coachPlanButtonText: { color: '#003737', fontFamily: 'Inter_700Bold', fontSize: 14 },
  coachMathButton: { minHeight: 44, borderRadius: 22, borderWidth: 1, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  coachMathButtonText: { fontFamily: 'Inter_600SemiBold', fontSize: 13 },
  coachSourceNote: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 },
  coachSourceText: { flexShrink: 1, fontFamily: 'Inter_400Regular', fontSize: 9, lineHeight: 13, textAlign: 'center' },
  promptBoard: { flexGrow: 1, paddingVertical: 8, gap: 16 },
  coachPromptHero: { gap: 5, paddingVertical: 4 },
  coachPromptTitle: { fontFamily: 'Inter_700Bold', fontSize: 27, lineHeight: 32, letterSpacing: -0.5 },
  coachPromptBody: { fontFamily: 'Inter_400Regular', fontSize: 13, lineHeight: 19, maxWidth: 330 },
  coachPromptGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  coachPromptCard: { flexGrow: 1, flexBasis: '47%', minHeight: 138, borderWidth: 1, borderRadius: 20, padding: 13, gap: 6, shadowColor: '#000', shadowOpacity: 0.14, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 },
  coachPromptIcon: { width: 32, height: 32, borderRadius: 11, alignItems: 'center', justifyContent: 'center', marginBottom: 1 },
  coachPromptKicker: { fontFamily: 'Inter_700Bold', fontSize: 9, lineHeight: 13, letterSpacing: 0.3 },
  coachPromptCardTitle: { fontFamily: 'Inter_600SemiBold', fontSize: 13, lineHeight: 18 },
  coachPromptCta: { marginTop: 'auto', flexDirection: 'row', alignItems: 'center', gap: 2 },
  coachPromptCtaText: { fontFamily: 'Inter_500Medium', fontSize: 10 },
  coachComposerDock: { flexShrink: 0, paddingHorizontal: 14, paddingTop: 8, paddingBottom: 7 },
  composer: { minHeight: 56, borderWidth: 1, borderRadius: 28, flexDirection: 'row', alignItems: 'center', paddingLeft: 15, paddingRight: 6, paddingVertical: 5, gap: 8, shadowColor: '#000', shadowOpacity: 0.25, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 5 },
  composerInput: { flex: 1, minHeight: 44, fontFamily: 'Inter_400Regular', fontSize: 14 },
  coachSendButton: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center' },
  coachDisclaimer: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 9, lineHeight: 13, textAlign: 'center' },
