...
4. Monitor `/admin` launch metrics twice daily for the first week: active users, paid users, MRR, churn, referrals, verified Money Wins, Freelancer Mode adoption, Household Sharing adoption, and Voice Brief completion.
