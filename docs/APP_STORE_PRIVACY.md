...
| Financial Info: Other Financial Info | Yes | App functionality, analytics within the product | Plaid account balances, account metadata, transactions, recurring streams, goals, Freelancer Mode profile settings, alerts, and coaching artifacts. |
...
| Usage Data: Product Interaction | Yes | Analytics | First-party app events only: registration, linking, paywall, coach use, referrals, Freelancer Mode use, and beta/launch retention events. |
